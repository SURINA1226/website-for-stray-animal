...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >帖子详细信息页面</th>
  </tr>
  <tr>
    <td class="CPanel">
        <legend>详细信息</legend>
                      ...
                      <span class="red"> *</span></td>
                        ...
                        <tr>
                         ...
                         <tr>
                          ...
                          <td><input name="txtsex" class="text" style="width:154px" value="<%=rs.getString("sex") %>" />
  
       
      </select></td>
                          <td align="right">健康情况:</td>
                          <td><input name="txthealth" class="text" style="width:154px" value="<%=rs.getString("health") %>" />
